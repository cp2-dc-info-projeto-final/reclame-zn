...
if(isset($_POST['registrar'])){
    ...
    $atualiza_dados = "UPDATE tb_usuarios SET nome = :nome, email = :email, senha = :senha WHERE id = :id" ;
    $sql->QuerySQL($atualiza_dados, array(
        ":nome" => $nome,
        ":email" => $email,
        ":senha" => password_hash($senha, PASSWORD_DEFAULT),
        ":id" => $_SESSION['USER_GLOBAL_DATA_INFORMATION']['id']
    ));
    ...
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
         <form class="login100-form validate-form flex-sb flex-w" action="/html/editar.php" method="post">
                    ...
                    <span class="txt1 p-b-11"> Novo nome </span>
                    ...
                    <span class="txt1 p-b-11"> Novo e-mail </span>
                    <div class="wrap-input100 validate-input m-b-36" data-validate="O e-mail é necessário">
                        <input class="input100" type="text" name="email">
                        <span class="focus-input100"></span>
                    </div>

                    <span class="txt1 p-b-11">Confirme o novo e-mail</span>

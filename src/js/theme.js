...
(function($) {
	...
	*/
	var $noticeTopBar = {
		...
		init: function() {
			...
			if( !$.cookie('RECLAMEZNNoticeTopBarClose') ) {
				self
					.build()
					.events();
			} else {
		...
		saveCookie: function() {
			...
			$.cookie('RECLAMEZNNoticeTopBarClose', true);
	...
	* Toggle Class
	*/
	$('[data-RECLAMEZN-toggle-class]').on('click', function (e) {
		e.preventDefault();

		$(this).toggleClass( $(this).data('RECLAMEZN-toggle-class') );
	});
...
(function(theme, $) {
	...
	PluginGDPR.prototype = {
		...
		build: function() {
			...
			// Show
			if( !$.cookie( 'RECLAMEZN-privacy-bar' ) ) {
				$(window).on('load', function(){
					setTimeout(function(){
			...
			if( $.cookie( 'RECLAMEZN-gdpr-preferences' ) ) {
				var preferencesArr = $.cookie( 'RECLAMEZN-gdpr-preferences' ).split(',');
		...
		events: function() {
			...
			self.options.wrapper.find('.gdpr-agree-trigger').on('click', function(e){
				...
				$.cookie( 'RECLAMEZN-privacy-bar', true );
			...
			$('.gdpr-preferences-form').on('submit', function(e){
				...
				$.cookie( 'RECLAMEZN-privacy-bar', true );
				$.cookie( 'RECLAMEZN-gdpr-preferences', formData );
		...
		clearCookies: function() {
			...
			$.removeCookie( 'RECLAMEZN-privacy-bar' );
			$.removeCookie( 'RECLAMEZN-gdpr-preferences' );
...
(function(theme, $) {
	...
	PluginGDPRWrapper.prototype = {
		...
		build: function() {
			...
			if( $.cookie( 'RECLAMEZN-gdpr-preferences' ).indexOf( self.options.checkCookie ) != -1 ) {
				$.ajax({

	...
	<body data-plugin-page-transition>
		...
		<header style="background-color:#14213D;" id="header" class="header-effect-shrink" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyChangeLogo': true, 'stickyStartAt': 30, 'stickyHeaderContainerHeight': 100}">
            ...
            <div>
                ...
                <p style="font-size:200% ; padding-left: 20px; padding-bottom: 12px;">Expor os problemas mais recorrentes da Zona Norte.</p>
            </div>

            <div>
                <p style="font-size:300%; color: black;  padding-left: 30px; padding-bottom: 0px;" >-Como funciona o site?</p>

                <p style="font-size:200%; padding-left: 20px; padding-bottom: 12px; ">Funciona em forma de rede social, com relatos, respostas e curtidas.</p>
            </div>

            <div>
                <p style="font-size:300%; color: black;  padding-left: 30px; padding-bottom: 0px;">-O que eu posso fazer para contribuir?</p>

                <p style="font-size:200% ; padding-left: 20px; padding-bottom: 12px;">Morador da Zona Norte, deixe um relato ou experiência e mostre para o povo sua indignação.</p>
            </div>
